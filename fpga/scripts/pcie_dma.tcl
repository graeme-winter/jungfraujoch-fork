...
proc create_hier_cell_pcie_dma { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net s_axis_c2h_datamover_cmd_1 [get_bd_intf_pins s_axis_c2h_datamover_cmd] [get_bd_intf_pins gen_xdma_descriptor_c2h/S_AXIS]
  connect_bd_intf_net -intf_net s_axis_h2c_datamover_cmd_1 [get_bd_intf_pins s_axis_h2c_datamover_cmd] [get_bd_intf_pins gen_xdma_descriptor_h2c/S_AXIS]
  ...
  connect_bd_net -net s_axis_aresetn_1 [get_bd_pins s_axis_aresetn] [get_bd_pins axi_firewall_0/aresetn] [get_bd_pins gen_xdma_descriptor_c2h/resetn] [get_bd_pins gen_xdma_descriptor_h2c/resetn] [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net usr_irq_req_1 [get_bd_pins usr_irq_req] [get_bd_pins xdma_0/usr_irq_req]
  connect_bd_net -net xdma_0_axi_aclk [get_bd_pins axi_aclk] [get_bd_pins axi_firewall_0/aclk] [get_bd_pins gen_xdma_descriptor_c2h/clk] [get_bd_pins gen_xdma_descriptor_h2c/clk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins xdma_0/axi_aclk]
