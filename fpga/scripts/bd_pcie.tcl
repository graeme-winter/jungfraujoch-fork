...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net zero_dout [get_bd_pins axi_quad_spi_0/usrcclkts] [get_bd_pins jungfraujoch/mm2s_error] [get_bd_pins jungfraujoch/s2mm_error] [get_bd_pins zero/dout]
