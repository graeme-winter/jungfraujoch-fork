...
proc create_hier_cell_hbm_infrastructure { parentCell nameHier hbmStackSelect } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.USER_CLK_SEL_LIST0 {AXI_10_ACLK} \
  ...
  connect_bd_net [get_bd_pins hbm_clk] [get_bd_pins hbm/HBM_REF_CLK_0]
  connect_bd_net [get_bd_pins resetn] [get_bd_pins resetn_sync_0/in_resetn]
  connect_bd_net [get_bd_pins refclk100] [get_bd_pins hbm/APB_0_PCLK] [get_bd_pins resetn_sync_0/clk]
  ...
  for {set i 0} {$i < 12} {incr i} {
      ...
      connect_bd_net [get_bd_pins clk] [get_bd_pins axi4_to_axi3_$i/aclk] [get_bd_pins axi_register_slice_$i/aclk]

      connect_bd_net [get_bd_pins resetn] [get_bd_pins axi_register_slice_$i/aresetn]
      connect_bd_net [get_bd_pins resetn] [get_bd_pins axi4_to_axi3_$i/aresetn]
      ...
      if {$i < 10} {
        connect_bd_net [get_bd_pins resetn] [get_bd_pins hbm/AXI_0${i}_ARESET_N]
        connect_bd_net [get_bd_pins clk] [get_bd_pins hbm/AXI_0${i}_ACLK]
        connect_bd_intf_net [get_bd_intf_pins axi_register_slice_$i/M_AXI] [get_bd_intf_pins hbm/SAXI_0${i}*]
      } else {
        connect_bd_net [get_bd_pins resetn] [get_bd_pins hbm/AXI_${i}_ARESET_N]
        connect_bd_net [get_bd_pins clk] [get_bd_pins hbm/AXI_${i}_ACLK]
