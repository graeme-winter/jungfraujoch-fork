...
class SpotFinder {
    ...
    int16_t *host_in_buffer;

    void *gpu_in;
    uint8_t *gpu_out, *host_out;
    int numberOfSMs;
...
public:
    ...
    void FindSpots(const DiffractionExperiment &experiment, const JFJochProtoBuf::DataProcessingSettings &settings,
                   std::vector<DiffractionSpot> &vec, int64_t image_number);
